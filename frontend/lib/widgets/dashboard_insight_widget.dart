...
class DashboardInsightSection extends StatelessWidget {
  const DashboardInsightSection({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                t("dashboard_insights.subheading"),
                style: subStyle,
              ),
              ...
              stepItem(
                "1",
                t("dashboard_insights.part1"),
                t("dashboard_insights.subpart1"),
              ),

              stepItem(
                "2",
                t("dashboard_insights.part2"),
                t("dashboard_insights.subpart2"),
              ),

              stepItem(
                "3",
                t("dashboard_insights.part3"),
                t("dashboard_insights.subpart3"),
              ),

              stepItem(
                "4",
                t("dashboard_insights.part4"),
                t("dashboard_insights.subpart4"),
              ),

              stepItem(
                "5",
                t("dashboard_insights.part5"),
                t("dashboard_insights.subpart5"),
              ),

              stepItem(
                "6",
                t("dashboard_insights.part6"),
                t("dashboard_insights.subpart6"),
              ),

              stepItem(
                "7",
                t("dashboard_insights.part7"),
                t("dashboard_insights.subpart7"),
              ),
            ],
          ),
        ),
